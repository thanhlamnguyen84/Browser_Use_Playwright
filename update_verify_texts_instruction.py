...
async def test_main():
    ...
    # print(f"\nKết qua got: {data["first_label_field_name"]}")
    # print(f"\nKết qua got: {data["second_label_field_name"]}")
    # data = history.extracted_content()
    # result1 = json.loads(data)
    # result = ExtractResults.model_validate_json(result1)
    # Convert 'data' to the ExtractResults model
    # print("\n🔹 Extracted Content:\n", result)
    # assert "Email / Mobile Number" == result.first_label_field_name, "Expected 'Email / Mobile Number' not found"
    # assert "Password" == result.second_label_field_name, "Expected 'Password' not found"
